...
BASE_DIR = os.path.dirname(os.path.abspath("SMART_RELATIONSHIP_MANAGEMENT_SYSTEM"))
...
class LoginWindow(QWidget):
    def __init__(self):
        ...
        bg_path = os.path.join(BASE_DIR, "static/background_login.png")  # Use absolute path
        ...
        '''
        # ✅ Centered Login Box (New Stylish Design)
        box_width = 400  # Slightly wider box for better spacing
        box_height = 400  # Increased height for clean UI
        ...
        self.title.setStyleSheet("color: #333; padding-bottom: 10px;")
